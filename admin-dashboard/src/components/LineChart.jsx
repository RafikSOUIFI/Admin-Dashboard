...
const LineChart = ({ isCustomLineColors = false, isDashboard = false, purchases}) => {
  ...
  var incomeData = []
 if(purchases) {
  temp=purchases.map((e)=> {return {x: e.date, y: e.number_of_items*e.cost}})
  incomeData = temp.reduce((result, { x, y }) => {
